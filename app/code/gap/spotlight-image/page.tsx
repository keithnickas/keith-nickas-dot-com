      ...
      mainImage: [
        {
          image: {
            _meta: {
              schema: "http://**.**/cms/schema/v1/core#/definitions/image-link",
            },
  ...
  return (
    <div className="max-w-7xl min-h-screen py-24 px-4 flex-nowrap max-lg:flex-wrap mx-auto">
      ...
      <div className="flex gap-4 lg:my-20 lg:w-full justify-center flex-nowrap max-lg:flex-wrap">
        <div className="grid justify-items-stretch">
          <p className="text-white pt-4">
            ...
            content on the Athleta website (as of August, 2025).
          </p>
          <p className="text-white pt-4">
            The component is built using React, receiving a JSON payload from a
            CMS provider. The JSON is processed then rendered on the page.
          </p>
          <p className="text-white pt-4">
            The wireframes show optionally displaying image, headline,
            subheading, and CTA link or button. The component can optionally
      ...
      <div className="flex lg:my-20 max-lg:my-6 flex-wrap">
        <h2 className="h2 text-3xl font-light text-white sm:text-4xl pb-6">
          Wireframes
        </h2>
