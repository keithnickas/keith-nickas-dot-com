...
const gapCaseStudy: CaseStudy = {
    ...
    metrics: [
      {
        label: "Users Served",
        value: "Millions",
        description: "across Gap & Banana Republic",
      },
      {
  ...
  componentShowcase: [
    ...
    },
    {
      ...
      examples:
        "Text fields, select dropdowns, checkboxes, radio buttons, validation patterns",
    },
    {
      category: "Product Display",
      examples:
        "Product cards, image galleries, quickview modals, size selectors, color swatches",
    },
    {
      category: "E-commerce",
      examples:
        "Shopping cart, checkout flows, payment forms, order confirmations",
    },
    {
      category: "Content & Media",
      examples:
        "Hero banners, content cards, video players, image carousels, promotional modules",
    },
    {
      category: "Feedback & Status",
      examples:
        "Loading states, error messages, toast notifications, progress indicators",
    },
  ],
  learnings: [
