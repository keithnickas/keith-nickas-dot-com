...
const deemRecruiterCaseStudy: RecruiterCaseStudy = {
  ...
  modal: {
    ...
    url: "https://www.figma.com/design/pI3hmMyRy36GTRTHXu9g9P/Flight-Redesign?node-id=0-1&t=AqQ8WyFhGlA4Ae4g-1"
  },
  tags: [
  ...
  executiveSummary:
    "Led transformation of legacy travel booking platform into modern React SPA, establishing shared component libraries and best practices adopted across global engineering teams. Mentored 15+ developers across three continents while reducing operating costs through strategic refactoring and modern optimization techniques.",

  businessContext: {
    situation:
      "Legacy travel booking platform built on outdated server-side rendering made rapid iteration difficult, created inconsistent user experiences, and slowed development cycles as system grew organically over years.",
    stakeholders: [
      "Engineering Leadership",
      "Product Management",
      "Global Development Teams (US, India, Eastern Europe)",
      "QA Teams",
    ...
    constraints: [
      ...
      "Support existing customer base without disruption",
      "Balance new feature development with modernization efforts",
    ],
  },

  roleResponsibilities: {
    scope:
      "Technical leadership for frontend modernization initiative impacting multiple teams across continents. Owned architecture decisions and mentored global team members.",
  ...
  capabilities: [
    {
      ...
      description:
        "Led complex platform migration while maintaining business continuity and delivering new features",
      examples: [
    ...
    },
    {
      ...
      description:
        "Effectively led and developed distributed teams across multiple time zones and cultures",
      examples: [
    ...
    },
    {
      ...
      description:
        "Built component libraries and established patterns that increased team velocity organization-wide",
      examples: [
    ...
    },
    {
      ...
      description:
        "Championed testing and accessibility practices that became team standards",
      examples: [
  ...
  leadership: [
    {
      ...
      description:
        "Successfully mentored and upskilled engineers across three continents, creating force multipliers that accelerated the entire organization.",
    },
    {
      title: "Change Management",
      description:
        "Led organization through significant technical transformation, managing stakeholder expectations while maintaining team morale and productivity.",
    },
    {
      title: "Standards & Best Practices",
      description:
        "Established testing, accessibility, and code quality standards that outlasted individual projects and elevated organizational capabilities.",
    },
  ],
