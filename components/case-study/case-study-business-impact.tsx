...
const CaseStudyBusinessImpact = ({
  ...
  <section className="px-6 py-12">
    <div className="max-w-4xl mx-auto">
      <h2 className="text-3xl md:text-4xl font-bold mb-8">{impact?.title}</h2>
          ...
          return (
            ...
            >
              {IconComponent !== undefined ? (
                <div
                  className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${iconBgColor ? iconBgColor : "bg-cyan-500"}`}
                >
