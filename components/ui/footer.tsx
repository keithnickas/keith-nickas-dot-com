        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link href="https://github.com/keithnickas" className="flex justify-center items-center text-teal-600 bg-gray-800 hover:text-gray-100 hover:bg-teal-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href="https://www.linkedin.com/in/keith-nickas" className="flex justify-center items-center text-teal-600 bg-gray-800 hover:text-gray-100 hover:bg-teal-600 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin" target="_blank">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
